		...
		<div class="row">
			<div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
				...
				<transition appear :name='alertAnimation' mode="out-in">
					...
					<div class="alert alert-danger" v-else key="warning">
				...
				<transition
					...
					:css="false"
					>
					<div style="width:450px; height: 100px; background-color: lightgreen" v-if="load"></div>
				</transition>
				<hr>
		...
		methods: {
			...
			enter(el, done){
				...
				const interval = setInterval(()=> {
					...
					round++;
					if (round > 35) {clearInterval(interval)}
					done();
				}, 20)
			},
			afterEnter(el){
